...
class TeamDB
{
    ...
    public function __construct($configFile) 
    {
        ...
        if ($ini = parse_ini_file($configFile))
        {
            ...
            $custPDO->setAttribute(PDO::ATTR_EMULATE_PREPARES, false);
...
//  5) Return results if needed.
    ...
    public function getTeams() 
    {
        ...
        // Preparing SQL query
        $stmt = $custTable->prepare("SELECT * FROM patients ORDER BY patientLastName"); 
    ...
    public function getTeam ($id) 
    {
        ...
        // Preparing SQL query 
        //    id is used to ensure we delete correct record
        $stmt = $custTable->prepare("SELECT id, patientFirstName, patientLastName, patientMarried, patientBirthDate FROM patients WHERE id=:idParam");
