<?php
  ...
  elseif (isset($_POST['action'])) 
  {
      ...
      if ($action == "Add") 
      {
          $result = $bookDatabase->addBook($title, $author, $releaseDate, $isbn, $genre);
      } 
      elseif ($action == "Update") 
      {
          $result = $bookDatabase->updateBook($id, $title, $author, $releaseDate, $isbn, $genre);
      }
